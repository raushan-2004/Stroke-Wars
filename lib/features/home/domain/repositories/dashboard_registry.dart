  ...
  List<DashboardModule> getSecondaryModules() {
    return const [
      ...
      DashboardModule(
        id: 'social',
        title: 'Social Hub',
        subtitle: 'Connect with friends and form party lobbies.',
      ...
      DashboardModule(
        ...
        subtitle: 'Complete daily and weekly challenges.',
      ...
      DashboardModule(
        ...
        subtitle: 'Unlock skins, frames, and trails.',
      ...
      DashboardModule(
        id: 'leaderboard',
        title: 'Leaderboards',
        subtitle: 'Stand tall against global sketchers.',
