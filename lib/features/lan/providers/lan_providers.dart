...
/// Riverpod provider adapter for accessing the [LANSessionController] and the active [LANSession] state.
@riverpod
class LANSessionState extends _$LANSessionState {
  late final LANSessionController _controller;
  ...
  LANSession build() {
    ...
    _controller = LANSessionController(
  ...
  /// Exposes the plain Dart [LANSessionController] instance.
  LANSessionController get controller => _controller;
}
